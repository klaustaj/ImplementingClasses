...
class Point(object):
    """ Constructs a point object in 2-space. """
    ...
    def move_to(self, x, y):
        ...
        self.number_moves_made = self.number_moves_made + 1

        move_dist = math.sqrt((self.x - oldx) ** 2 + (self.y - oldy) ** 2)
        self.dist_travelled = self.dist_travelled + move_dist
    ...
    def get_number_of_moves_made(self):
        return self.number_moves_made

    def get_distance_from(self, p2):
        return math.sqrt((self.x - p2.x) ** 2 + (self.y - p2.y) ** 2)

    def get_distance_from_start(self):
        return math.sqrt((self.x - self.startx) ** 2 + (self.y - self.starty) ** 2)
